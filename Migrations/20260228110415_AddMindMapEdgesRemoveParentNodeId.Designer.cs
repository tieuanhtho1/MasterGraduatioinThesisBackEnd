...
namespace WebAPI.Migrations
{
    ...
    [Migration("20260228110415_AddMindMapEdgesRemoveParentNodeId")]
    partial class AddMindMapEdgesRemoveParentNodeId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAPI.Models.MindMapEdge", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebAPI.Models.MindMapEdge", b =>
                {
                    ...
                    b.HasOne("WebAPI.Models.MindMapNode", "SourceNode")
                        .WithMany("SourceEdges")
                        .HasForeignKey("SourceNodeId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("WebAPI.Models.MindMapNode", "TargetNode")
